      ...
      <form action="">
        ...
        gap-[10px] bg-white p-5 shadow-lg shadow-greyIsh-700'>
          ...
          <div className='flex gap-2 items-center'>
            ...
            focus:outline-none w-[100%]' placeholder='Search by job title' />
          ...
          <button className='bg-blueIshColor h-full p-5 px-10 rounded-[10px] text-white 
          cursor-pointer hover:bg-blue-300'>Search
          </button>
        </div>
