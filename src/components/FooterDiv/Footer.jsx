      ...
      <div>
        <div className='logoDiv'>
          <h1 className='logo text-[25px] text-white pb-[1.5rem]'>
            <strong>Career</strong>XSearch
          </h1>
        </div>
        <p className='text-white pb-[13px] opacity-70 leading-7'>
          We always make our career searchers and companies find the best jobs, and employers find the best candidates.
        </p>
      </div>
      ...
      <div className='grid'>
        ...
        <div>
          <small className='text-[14px] text-white'>
            c.best-zambrana@erasolutions.us
          </small>
